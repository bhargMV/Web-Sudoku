 ...
 */
public class SudokuCreate extends HttpServlet {

    private int[][] solution;       // Generated solution.
    private int[][] game;           // Generated game with user input.
    private int[][] par_game;      // Stores the current game with user inputs  
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            newGame();           
             par_game=new int[9][9];
             for(int i=0;i<9;i++)
             {
                 for(int j=0;j<9;j++)
                 {
                     par_game[i][j]=game[i][j];
                 }
             }
            ...
            ses.setAttribute("solution",solution);
